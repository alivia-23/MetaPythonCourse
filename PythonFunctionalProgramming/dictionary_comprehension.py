...
print('Using one input list to create dictionary: ', numdict)
...
# Here I used the zip function that combines the two lists. When the two lists are of unequal length,
# the length of the shorter list is the length of the dictionary.
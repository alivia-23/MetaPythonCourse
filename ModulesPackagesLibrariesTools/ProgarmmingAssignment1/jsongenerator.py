...
def write_json_to_file(json_obj, output_file):
    ...
    """
    ### WRITE SOLUTION HERE
    '''I used the the path where to store my employee json file since I modularized 
    my programming assignment 
    Earlier if I use open() and pass output_file as parameter the employee json object
    was created in the global project and not inside the specific folder that I am working with
    So, I passed the path of my project to where the employee json object needed to be created
    '''
    # newfile =  open(output_file, mode='w')  # employee json was created globally in the project
    newfile =  open("/Users/aliviaguin/MetaPython/ModulesPackagesLibrariesTools/ProgarmmingAssignment1/employee.json", mode='w')
